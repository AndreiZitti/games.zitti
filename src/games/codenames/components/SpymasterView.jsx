...
export function SpymasterView({
  ...
  const isGivingClue = isMyTurn && !room.current_clue
  const isWatchingGuess = isMyTurn && room.current_clue

  return (
    <div className="screen codenames-spymaster">
      <div className="game-header">
        <div className="room-info">
          <span className="room-code">{room.code}</span>
          <span className="role-badge spymaster">Spymaster</span>
        </div>
      ...
      {/* Clue input for spymaster on their turn */}
      {isGivingClue && (
